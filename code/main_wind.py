...
#initial parameters
'''
		LR1		LR2		D		DROPOUT		period		EPOCH	alpha	Activate	w
1-5:	0.01	0.01	0.75	0			0			300		1		ReLU		0
6-10:	0.01	0.01	0.15	0			5			300		2		ReLU		0
11-15:	0.01	0.01	0.75	0			10			300		1		ReLU		0
16-20:	0.01	0.01	0.5		0			15			300		1		ReLU		0
21-25:	0.01	0.01	0.9		0.8			20			300		1		ReLU		0
26-30:	0.01	0.01	0.9		0			25			300		1		ReLU		0
31-35:	0.01	0.01	0.25	0			30			300		1		ReLU		0
36-40:	0.01	0.01	0.8		0			35			300		1		ReLU		0
41-45:	0.01	0.01	0.7		0.7			40			300		1		ReLU		0.08
46-50:	0.01	0.01	0.95	0.7			45			300		1		ReLU		0
51-55:	0.01	0.01	0.95	0			50			300		1		ReLU		0.01
56-60:	0.01	0.01	0.9		0.3			55			300		1		ReLU		0.05
61-65:	0.01	0.01	0.5		0.1			60			300		1		ReLU		0
66-70:	0.01	0.01	0.6		0.9			65			300		1		ReLU		0
71-75:	0.01	0.01	0.95	0.6			70			300		1		ReLU		0
76-80:	0.01	0.01	0.4		0			75			300		1		ReLU		0
'''
LR1 = 0.01
LR2 = 0.01
D = 0.75
...
train_time_points = 100


data = np.loadtxt('wind.txt')
'''
...
'''
after predicting all the 80 time points, train the model by the consistent-training scheme. 
'''
'''
# load the true value of label (180 time points)
Label = np.loadtxt('label.txt')
