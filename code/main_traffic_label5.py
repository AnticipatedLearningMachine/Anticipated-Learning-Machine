...
1-5:	0.05	0.05	0.1		0.1		0		100		10		Tanh
6-10:	0.05	0.05	0.1		0.1		5		100		10		Tanh
'''
LR1 = 0.05
LR2 = 0.05
D = 0.1
...
'''
# load the true value of 5label (60 time points)
Label = np.loadtxt('5label.txt')
